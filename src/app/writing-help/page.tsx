              ...
              <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                <Card className="hover:shadow-elegant transition-all">
                  ...
                  <CardContent className="space-y-3 text-muted-foreground">
                    ...
                    <ul className="space-y-2 pl-4 text-sm">
                      <li>&bull; &quot;May their memory be a blessing&quot; (zichronam livracha)</li>
                      <li>&bull; &quot;Of blessed memory&quot; (z&quot;l)</li>
                      <li>&bull; &quot;May their soul be bound up in the bond of eternal life&quot;</li>
                    </ul>
                  </CardContent>
                </Card>
                ...
                <Card className="hover:shadow-elegant transition-all">
                  ...
                  <CardContent className="space-y-3 text-muted-foreground">
                    ...
                    <ul className="space-y-2 pl-4 text-sm">
                      <li>&bull; <strong>Chesed</strong> - Acts of loving kindness</li>
                      <li>&bull; <strong>Tzedakah</strong> - Charity and justice</li>
                      <li>&bull; <strong>Tikkun Olam</strong> - Repairing the world</li>
                      <li>&bull; <strong>Kavod</strong> - Honor and respect</li>
                      <li>&bull; Include relevant Torah quotes or Talmudic wisdom</li>
                    </ul>
                  </CardContent>
                </Card>
                ...
                <Card className="hover:shadow-elegant transition-all">
                  ...
                  <CardContent className="space-y-3 text-muted-foreground">
                    ...
                    <ul className="space-y-2 pl-4 text-sm">
                      <li>&bull; Synagogue membership and involvement</li>
                      <li>&bull; Jewish organizations and causes</li>
                      <li>&bull; Yahrzeit date (Hebrew calendar)</li>
                      <li>&bull; Service details (timing respects Shabbat)</li>
                      <li>&bull; Shiva information and house location</li>
                    </ul>
                  </CardContent>
                </Card>
              </div>
            ...
            <div className="mb-24">
              ...
              <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
                ...
                <Card className="hover:shadow-elegant transition-all border-l-4 border-l-primary">
                  ...
                  <CardContent className="text-muted-foreground space-y-3">
                    <p><strong className="text-foreground">The mistake:</strong> Using clichés like &quot;loved by all&quot; without specific examples of their personality.</p>
              ...
              <Card className="max-w-4xl mx-auto p-12 bg-gradient-to-br from-primary/5 via-background to-secondary/5 border-2 border-primary/20">
                <CardContent className="pt-6">
                  ...
                  <p className="text-sm text-muted-foreground mt-6">
                    100% free &bull; No credit card required &bull; Edit anytime &bull; Support available 24/7
                  </p>
                </CardContent>
              </Card>
            </div>
