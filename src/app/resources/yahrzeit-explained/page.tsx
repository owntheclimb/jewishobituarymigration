...
const articleSchema = generateArticleSchema({
  ...
  url: 'https://jewishobituary.com/resources/yahrzeit-explained',
...
const breadcrumbSchema = generateBreadcrumbSchema([
  ...
  { name: 'Yahrzeit Explained', url: 'https://jewishobituary.com/resources/yahrzeit-explained' },
]);
...
export default function YahrzeitExplainedPage() {
        ...
        <article className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <Card className="mt-12 p-6 bg-muted/30">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Link href="/resources/chevra-kadisha" className="group block p-4 rounded-lg hover:bg-background transition-colors">
                <h4 className="font-semibold text-foreground mb-2 group-hover:text-primary transition-colors">
                  Chevra Kadisha: The Holy Society
                </h4>
                <p className="text-sm text-muted-foreground">The sacred work of preparing the deceased for burial</p>
              </Link>
            </div>
          </Card>
